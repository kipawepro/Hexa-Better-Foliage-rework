...
import com.eerussianguy.betterfoliage.ClientTickHandler;
...
public class SoulParticle extends SingleQuadParticle
{
    ...
    public void tick()
    {
        ...
        if (children && (age == 5 || age == 10 || age == 15))
        {
            ...
            Helpers.addParticle(particle, ClientTickHandler.getTextures(ParticleLocation.SOUL_TRAIL, null));
        }
    }
